...
## Описание проекта
GASPR Case - это система для анализа резюме соискателей и сопоставления их с вакансиями на основе навыков. Проект предназначен для автоматизации процесса подбора кандидатов для HR-специалистов и помощи соискателям в поиске подходящих вакансий.
...
3. Запустить PostgreSQL и создать необходимые таблицы.
...
- `POST /api/send_resume` - Отправка резюме для анализа без регистрации
