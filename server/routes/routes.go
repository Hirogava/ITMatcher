...
func StaticRoutes(r *mux.Router, manager *db.Manager) {
	...
	hr.Use(middleware.AuthRequired("hr"))
	users := r.PathPrefix("/user").Subrouter()
	users.Use(middleware.AuthRequired("users"))
	...
	hr.HandleFunc("/finders", func(w http.ResponseWriter, r *http.Request) {
	...
	// хряк WW
	hr.HandleFunc("/acc", func(w http.ResponseWriter, r *http.Request) {
	...
	hr.HandleFunc("/vacancies", func(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	users.HandleFunc("/acc", func(w http.ResponseWriter, r *http.Request) {
	...
	users.HandleFunc("/resumes", func(w http.ResponseWriter, r *http.Request) {
